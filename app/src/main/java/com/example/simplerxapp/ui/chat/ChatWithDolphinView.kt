...
fun ChatWithDolphinView(
                ...
                items(messagesList) { message ->
                    if (message is ChatMessage.Sent) {
                        SenderBubbleView(
                            ...
                            onViewFeedbackAction = { action ->
                                bottomSheetFeedbackData = action
    ...
    if (bottomSheetFeedbackData != null) {
        ModalBottomSheet(
            ...
            LazyColumn (
                ...
                item {
                    Text(
                        ...
                        text = bottomSheetFeedbackData?.fullMessage ?: ""
                    )
                }
            }
        }
